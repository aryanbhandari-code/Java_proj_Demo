...
<head>
    ...
    <style>
        ...
        body {
            ...
            color: #265073; /* Dark Blue for general text */
        }
        
        /* Container Styles */
        .container-fluid {
            background-color: rgba(236, 244, 214, 0.9); /* Light Greenish background */
            padding: 30px;
            border-radius: 10px;
        ...
        .form-control:focus {
            ...
            box-shadow: 0 0 5px rgba(45, 149, 150, 0.5);
        }
        ...
        /* Additional Styles */
        b {
            color: #9AD0C2; /* Light Teal for emphasis */
        }
